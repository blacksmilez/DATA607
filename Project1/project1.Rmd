...
#### Team Member: Seung Min Song\
\
Read the text file by line using the readlines( ) function.
```{r readtxtfile-data, echo=TRUE, warning=FALSE}
file <- 'https://raw.githubusercontent.com/blacksmilez/DATA607/main/Project1/tournamentinfo.txt'
#file <- './7645617.txt'
...
[Github-https://github.com/blacksmilez/DATA607/blob/main/Project1/](https://github.com/blacksmilez/DATA607/blob/main/Project1/)
