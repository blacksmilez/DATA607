...
#### Collaboration Tools \
communication: Slack\
project mangement: GitHub Board\
code sharing: github\
project documentation: RStudio\
database: Microsoft Azure Database for MySQL Database
\
...
Finally, download the data as CSV and load the CSV file in R. 
...
**ERD**
![erd.png](https://github.com/blacksmilez/DATA607/blob/fb609fca13e514d4698bd7f643f20f74bcef7bcf/Project3/erd.png)
