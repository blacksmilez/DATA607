...
![overall average](overall_avg.png){width=450}
...
![year-to-date average](ytd.png){width=450}
...
```{r parition-by-order-by, echo=TRUE}
...
![six-day moving average](moving_avg.png){width=450}
...
```{r order-by-preceding, echo=TRUE}
